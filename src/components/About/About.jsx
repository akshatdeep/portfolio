...
import LetsTalkModal from "../LetsTalkModal/LetsTalkModal";  // <-- import the modal
...
const About = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(".lineChild", { y: "100%", opacity: 0 });
    ...
    <>
      ...
      >
        ...
        >
          ...
          <h3
            ref={headingRef}
            className="text-justify overflow-hidden cursor-pointer"
