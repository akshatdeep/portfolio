...
const About = () => {
 ...
 useEffect(() => {
  const ctx = gsap.context(() => {
    ...
    // === Step 1: Entrance animation (fade + rise) ===
    ...
    // === Step 2: Floating animation (AFTER entrance) ===
    tl.to(
      imgRef.current,
      {
        y: -18,
      ...
      "+=0.2" // wait 0.2 sec after entrance
    );
    ...
    <>
      ...
      >
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-6">
          <p className="text-stone-400 text-sm sm:text-base tracking-wide">(About Me)</p>
          ...
          >
            ...
            performance, user experience, and writing maintainable code that lasts.
          </p>
